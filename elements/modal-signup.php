<section class="modal modalSignup" id="modalSignup" data-location="modal-signup" style="display: none;">
    <div class="modal-container modal-lg">
        ...
        <div class="modal-body">
            <form class="modal-form" method="POST" action="/" enctype="multipart/form-data">
                ...
                <div class="input-group success">
                    ...
                    <span class="msg success" style="/*display: none;*/">Success text</span>
                </div>
                ...
                <div class="input-group input-password">
                    ...
                    <button class="buttonShowPass" type="button">
                        ...
                        <svg width="19" height="19" viewBox="0 0 31 25" fill="none" xmlns="http://www.w3.org/2000/svg" style="display: none">
                ...
                <div class="input-group">
                    <label class="file-input input" data-uploaded="false">
                        ...
                        <span class="filePlaceholder" data-placeholder="Upload photo">Upload photo</span>
                ...
                <div class="input-group w-100 error">
                    <label class="checkbox-input">
                        ...
                        <span class="title">I agree to the <a href="/privacy">Privacy Policy and Terms of Use</a>.</span>
                    </label>
                    <span class="msg error" style="/*display: none;*/">Error text</span>
                </div>
            </form>
        ...
        <div class="modal-footer">
            <button class="button yellow" type="submit">Registration</button>
        </div>
    </div>
</section>