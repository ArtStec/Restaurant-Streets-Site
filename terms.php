...
<main class="page-content">
    <section class="main-section privacy-section" data-location="privacy-main">
        ...
        <div class="content-wrapper">
            <div class="links-container" style="position: relative;">
                <ul>
                    <li>
                        <a href="#rule-1" class="link-item">About these Terms</a>
                    </li>
                    <li>
                        <a href="#rule-2" class="link-item">About accessing and using our Services</a>
                    </li>
                    <li>
                        <a href="#rule-3" class="link-item">Accounts</a>
                    </li>
                    <li>
                        <a href="#rule-4" class="link-item">Virtual Goods and Virtual Currency</a>
                    </li>
                    <li>
                        <a href="#rule-5" class="link-item">User Conduct and Materials</a>
                    </li>
                    <li>
                        <a href="#rule-6" class="link-item">Game with Other Users</a>
                    </li>
                    <li>
                        <a href="#rule-7" class="link-item">Cases of Violation of Terms of Use</a>
                    </li>
                    <li>
                        <a href="#rule-8" class="link-item">Availability of Our Services</a>
                    </li>
                    <li>
                        <a href="#rule-9" class="link-item">Liability Limitation for Residents of the United States</a>
                    </li>
                    <li>
                        <a href="#rule-10" class="link-item">Liability Limitation for non-residents of the United States</a>
                    </li>
                    <li>
                        <a href="#rule-11" class="link-item">Intellectual property</a>
                    </li>
                    <li>
                        <a href="#rule-12" class="link-item">For residents of the United States of America - US government rights</a>
                    </li>
                    <li>
                        <a href="#rule-13" class="link-item">Confidentiality</a>
                    </li>
                    <li>
                        <a href="#rule-14" class="link-item">Links</a>
                    </li>
                    <li>
                        <a href="#rule-15" class="link-item">Transfer of Terms</a>
                    </li>
                    <li>
                        <a href="#rule-16" class="link-item">Entire Agreement</a>
                    </li>
                    <li>
                        <a href="#rule-17" class="link-item">Amendments</a>
                    </li>
                    <li>
                        <a href="#rule-18" class="link-item">Preservation of Effect</a>
                    </li>
                    <li>
                        <a href="#rule-19" class="link-item">Waiver of Our Rights</a>
                    </li>
                    <li>
                        <a href="#rule-20" class="link-item">Complaint Resolution and Disputes</a>
                    </li>
                    <li>
                        <a href="#rule-21" class="link-item">Questions Regarding These Terms</a>
                    </li>
                </ul>
            </div>
            <div class="content">
                ...
                <ol class="nested m-0">
                    <li>
                        ...
                        <ol class="m-0">
                            <li>
                                ...
                                to as the "Services" in these terms. These terms constitute a legal agreement and contain important information about your rights 
                    ...
                    <li>
                        ...
                        <ol class="m-0">
                            ...
                            <li>
                                ...
                                Virtual Currency, you acknowledge and agree that we will begin providing these goods or currency immediately upon completion of the 
                                transaction, and you forfeit the right to a refund. The "purchase" transaction is deemed completed at the moment of purchase confirmation 
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        You assume all risks of losing other game data (including game progress, levels, and earned points) at the moment of generating the 
                            ...
                            <li>
                                ...
                                system. Each partner payment system has its own terms and conditions that you should review before making a payment. If the payment through a 
                        ...
                        <ol class="m-0">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        Include viruses or other computer programs, files, or codes designed to block, destroy, or limit the functionality of software, 
                        ...
                        <ol class="m-0">
                            ...
                            <li>
                                ...
                                <p>
                                    ...
                                    visible to other users within the game or as part of our marketing activities.
                                </p>
                                <p>
                                    You also acknowledge and agree that other users may find you through a search using your email address. However, it is important to note 
                                    that we only display your display name in publicly available form, without revealing your email address. In order for another user to find 
                                    you through a search, they would need to know your email address.
                                </p>
                                <p>
                                    We strive to create a positive gaming experience for all users. Please remember these recommendations and cooperate with us in maintaining 
                    ...
                    <li>
                        ...
                        <ol class="m-0">
                            <li>
                                ...
                                <p>
                                    We also reserve the right to take additional measures based on the circumstances, including involving law enforcement authorities if necessary. 
                                    Please note that we evaluate each violation case individually, and the actions taken depend on the nature of the violation, its severity, and 
                                    your previous behavioral history. If you believe that your account has been mistakenly blocked or deleted, you can contact our support service 
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        Modification or Removal of Virtual Resources: We may modify the quantity and/or remove any virtual currency or virtual items associated 
                                        with your account;
                                    </li>
                                    <li>
                    ...
                    <li>
                        ...
                        <ol class="m-0">
                            ...
                            <li>
                                ...
                                that we may fully or partially terminate the provision of any of our services at our own discretion, without prior notice, and you agree 
                            ...
                            <li>
                                ...
                                portion of the services). We make no warranties regarding the availability of free services and have the right to modify or terminate 
                                their provision at our discretion, including for economic or technical reasons or to enhance user interaction. We are not liable for 
                                non-performance or delay in performance caused by unforeseen circumstances beyond our control. If such circumstances significantly 
                                impair the functionality of the services, your obligation to pay for downloads, use, or access to the services will be suspended for 
                                the duration of these circumstances. We have the right to change or terminate services paid with real money after providing you with 
                                appropriate advance notice.
                                <p>
                                    We make every effort to minimize availability issues and provide reliable and high-quality services. However, in case of problems, 
                    ...
                    <li>
                        ...
                        <p>
                            WE ARE NOT LIABLE FOR ANY ACTUAL, INCIDENTAL, OR CONSEQUENTIAL DAMAGES ARISING FROM THE OWNERSHIP OF GAMES, THEIR USE OR IMPROPER 
                            FUNCTIONING, OR ANY OTHER SERVICE WE PROVIDE, INCLUDING PROPERTY DAMAGE, COMPUTER MALFUNCTIONS, OR INJURIES, TO THE EXTENT PERMITTED 
                            BY LAW. OUR LIABILITY UNDER ANY CIRCUMSTANCES CANNOT EXCEED THE ACTUAL AMOUNT YOU PAID, IF ANY, FOR THE LICENSE TO USE VIRTUAL GOODS 
                            OR VIRTUAL CURRENCY, OR ANY OTHER COMPONENTS OF OUR GAMES OR SERVICES. SOME STATES DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES 
                            AND/OR EXCLUDE OR LIMIT LIABILITY FOR DAMAGES, SO THE ABOVE LIMITATIONS AND/OR EXCLUSIONS MAY NOT APPLY TO YOU. THIS WARRANTY GIVES 
                            YOU SPECIFIC RIGHTS, AND YOU MAY ALSO HAVE OTHER RIGHTS THAT VARY DEPENDING ON THE JURISDICTION.
                        </p>
                    </li>
                    <li>
                        ...
                        <ol class="m-0">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        losses or damages that could not reasonably have been foreseen by either party at the time of your agreement to these terms 
                                        and conditions, including losses resulting as a side effect of foreseeable losses, such as data loss, loss of opportunities, 
                                        service interruptions, computer or equipment malfunctions, financial loss;
                                    </li>
                                    <li>
                                        any damage to your devices through which you access or use the game or services, unless such damage is caused by our misconduct 
                                        or failure to adequately provide the games or services;
                                    </li>
                                    <li>
                    ...
                    <li>
                        ...
                        <p>
                            Our Services have been developed entirely at private expense and are commercial or restricted computer software. Use, duplication, 
                            or disclosure of the data by the Government of the United States of America or its subcontractors is subject to the restrictions 
                            set forth in DFARS 252.227-7013 regarding rights in technical data and computer software or the provisions of FAR 52.227-19 regarding 
                            restricted rights in commercial computer software, as applicable.
                        </p>
                    </li>
                    <li>
                        ...
                        <ol class="m-0">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        We may disclose anonymized or aggregated data that does not contain personal identification for statistical purposes or 
                                        research.
                                    </li>
                                </ul>
                            </li>
                    ...
                    <li>
                        ...
                        <p>
                            We have the right to transfer our rights or obligations under these terms, in whole or in part, to third parties without your consent. 
                            You agree to such transfer on our part, provided that it does not harm you. You are prohibited from transferring any rights granted to 
                            you by us under these terms without our prior written consent.
                        </p>
                    </li>
                    <li>
                        <h2 id="rule-16">Entire Agreement</h2>
                        <p>
                            These terms constitute the entire agreement between us and supersede all previous agreements and understandings between the parties. 
                            They apply to the services described in section 1 and are exhaustive with respect to this agreement.
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <p>
                            If any part of these terms is deemed invalid or unenforceable under applicable local laws or by a competent court decision, that part 
                            of the terms will be interpreted in a manner that complies with the requirements of applicable law and reflects our original intentions 
                            to the fullest extent. All other provisions of these terms remain valid and enforceable. If it is impossible to interpret the invalid 
                            or unenforceable part of the terms in a way that complies with applicable law, that part will be deemed excluded from these terms without 
                            affecting the validity of the remaining provisions.
                        </p>
                    </li>
                    <li>
                        <h2 id="rule-19">Waiver of Our Rights</h2>
                        <p>
                            Our failure to exercise or enforce any rights provided by these terms, or our waiver of pursuing such rights, does not constitute a waiver 
                            or limitation of our rights in the future. Any waiver of such rights is valid only if it is made in writing and signed by us.
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <p>
                            If you have any questions regarding these terms or our services, please contact us at support@streets.cafe. We will be glad to assist 
                            you and provide the necessary support.
                        </p>
                    </li>
                </ol>
            </div>
